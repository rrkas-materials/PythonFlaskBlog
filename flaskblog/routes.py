...
def account_func():
    ...
    if not os.path.exists(os.path.join(app.root_path, 'static', 'profile_pics', current_user.image_file)):
...
def login_func():
    ...
    if form.validate_on_submit():
        ...
        if user and bcrypt.check_password_hash(user.password, form.password.data):
            ...
            return redirect(next_page if next_page else url_for('home_func'))
        else:
